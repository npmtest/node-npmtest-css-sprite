...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-css-sprite/node_modules/css-sprite/bin/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-css-sprite/node_modules/css-sprite/bin/cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-css-sprite/node_modules/css-sprite/bin/</a> &#187; cli.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var fs = require('vinyl-fs');</span>
...
<span class="cstat-no" title="statement not covered" >  if (opts['no-sort']) {</span>
<span class="cstat-no" title="statement not covered" >    opts.sort = false;</span>
  }
<span class="cstat-no" title="statement not covered" >  console.log('Watching for file changes ...');</span>
<span class="cstat-no" title="statement not covered" >  fs.watch(opts.src, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    sprite.create(opts, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      console.log('&gt; Sprite created in ' + opts.out);</span>
    });
  });
}
else {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  sprite.create(opts);</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
